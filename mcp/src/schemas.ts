...
// Shared watch summary shape — reused by alertWatchOutput and alertListOutput
const watchSummaryShape = {
  id: z.string(),
  type: z.enum(["lending", "prediction", "rate", "carry", "yield"]),
  address: z.string().optional(),
  protocol: z.string().optional(),
  chain: z.string().optional(),
  healthFactorThreshold: z.number().optional(),
  rateCollateral: z.string().optional(),
  rateBorrowAsset: z.string().optional(),
  rateChain: z.string().optional(),
  rateProtocol: z.string().optional(),
  rateBorrowThreshold: z.number().optional(),
  rateSupplyThreshold: z.number().optional(),
  rateDirection: z.enum(["above", "below"]).optional(),
  rateUtilizationThreshold: z.number().optional(),
  carryCollateral: z.string().optional(),
  carryBorrowAsset: z.string().optional(),
  carrySupplyAsset: z.string().optional(),
  carryThreshold: z.number().optional(),
  yieldAsset: z.string().optional(),
  yieldChains: z.array(z.string()).optional(),
  yieldRisk: z.enum(["low", "medium", "high"]).optional(),
  yieldApyThreshold: z.number().optional(),
  yieldDirection: z.enum(["above", "below"]).optional(),
  webhookUrl: z.string().nullable().optional(),
  createdAt: z.string(),
};

export const alertWatchOutput = z.object({
  watch: z.object(watchSummaryShape),
  message: z.string(),
  usage: z.string(),
});
...
export const alertListOutput = z.object({
  ...
  watches: z.array(z.object({
    ...watchSummaryShape,
    // prediction-specific list fields
