...
export const lendingSupplyToolName = "lending.supply";
export const lendingWithdrawToolName = "lending.withdraw";

export const lendingSupplyDescription = `Build an unsigned supply transaction for a MetaMorpho curated vault (ERC-4626).
...
export const lendingWithdrawDescription = `Build an unsigned withdraw transaction for a MetaMorpho vault position (ERC-4626 redeem).
...
export async function handleLendingSupply(params: LendingSupplyParams): Promise<Record<string, unknown>> {
...
export async function handleLendingWithdraw(params: LendingWithdrawParams): Promise<Record<string, unknown>> {
  const receiver = tryAddress(params.receiver);
